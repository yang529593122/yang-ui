<template>
  ...
  <transition name="dialog-fade">
    <div class="yl-dialog__wrapper" v-show="visible" @click.self="handleClose">
      <div class="yl-dialog" :style="{width, marginTop: top}">
        ...
        <div class="yl-dialog__footer" v-if="$slots.footer">
